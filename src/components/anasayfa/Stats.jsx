      ...
      <div className="relative">
        ...
        <div className="relative max-w-[1440px] mx-auto px-6 lg:px-10 py-12">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
              <div
                className={`${rajdhani.className} inline-flex items-center gap-2 text-[#0B1F3A] uppercase tracking-[0.08em] text-[12px] font-semibold`}
                style={{ clipPath: chipClip, background: "#E8F3FF" }}
              >
                <span className="px-3 py-1">Üretim · Tedarik · Servis</span>
              </div>

              <h3
                className={`${rajdhani.className} mt-4 text-[#0B1F3A] font-bold uppercase tracking-[0.06em] text-3xl md:text-4xl lg:text-[40px] leading-snug`}
              >
                Üretiyoruz
              </h3>

              <p className="mt-3 text-[#1f2a44]/90 text-[14px] md:text-[15px] leading-relaxed max-w-xl">
                Güçlü motorlar, yüksek verimlilik ve sürdürülebilir enerji
                çözümleriyle her gün daha ileriye taşıyoruz. Optimus Prime
                olarak, her aşamada mükemmeli hedefliyor ve geleceğin enerjisini
                üretiyoruz.
              </p>
              ...
              <div className="mt-6 flex flex-wrap items-center gap-3">
                <span
                  className={`${rajdhani.className} inline-flex items-center text-[12px] uppercase tracking-[0.08em] font-semibold text-[#0B1F3A]`}
                  style={{ clipPath: chipClip, background: "#EAFBF0" }}
                >
                  <span className="px-3 py-1">Yüksek VERİMLİLİK</span>
                </span>
                <span
                  className={`${rajdhani.className} inline-flex items-center text-[12px] uppercase tracking-[0.08em] font-semibold text-[#0B1F3A]`}
                  style={{ clipPath: chipClip, background: "#F6F9FF" }}
                >
                  <span className="px-3 py-1">Güvenlİ Tedarİk</span>
                </span>
                <span
                  className={`${rajdhani.className} inline-flex items-center text-[12px] uppercase tracking-[0.08em] font-semibold text-[#0B1F3A]`}
                  style={{ clipPath: chipClip, background: "#FFF8EA" }}
                >
                  <span className="px-3 py-1">Garantİ & Servİs Ağı</span>
                </span>
              </div>
            </div>
      ...
      <div className="relative">
        ...
        <div className="relative max-w-[1440px] mx-auto px-6 lg:px-10 py-10 lg:py-14 bg-[#F7FAFF]">
          <div className="text-center">
            <h4
              className={`${rajdhani.className} text-[#102C8C] font-bold uppercase tracking-[0.06em] text-2xl md:text-3xl`}
            >
              Optimus Prime Motorlarına Güvenebilirsiniz!
            </h4>
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h5
                className={`${rajdhani.className} mt-4 text-[18px] md:text-[20px] font-semibold text-[#0B1F3A] uppercase tracking-[0.04em]`}
              >
                Kalite ve Performans
              </h5>
              <p className="mt-2 text-[14px] leading-relaxed text-gray-700 max-w-sm">
                Yüksek kalite standartlarıyla üretilen motorlarımız; güç ve
                verimliliği birleştirerek üstün performans sunar.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-2 text-[14px] leading-relaxed text-gray-700 max-w-sm">
                Optimize edilmiş tasarım; düşük tüketimle uzun vadede tasarruf ve
                çevre dostu kullanım sağlar.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-2 text-[14px] leading-relaxed text-gray-700 max-w-sm">
                Yaygın servis ağımız ve uzman ekibimizle hızlı, güvenilir hizmet
                sunarak memnuniyeti en üst seviyeye taşırız.
              </p>
            </div>
          </div>
        </div>
